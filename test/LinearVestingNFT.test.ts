...
// typechain
import { ERC20Mock__factory, ERC20Mock, LinearVestingNFT__factory, LinearVestingNFT } from "../typechain-types";
...
describe("LinearVestingNFT", function () {
  ...
  it("Returns a valid vested payout", async function () {
    ...
    const totalPayout = await linearVestingNFT.vestedPayoutAtTime(
      0,
      unlockTime
    );
