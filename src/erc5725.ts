 ...
 */
export function getERC5725Contract(address: string, signerOrProvider?: ethers.Signer | ethers.providers.Provider) {
    return new ethers.Contract(address, ERC5725_Artifact.abi, signerOrProvider) as ERC5725
}
 ...
 */
export async function supportsIERC5725(address: string, signerOrProvider: ethers.Signer | ethers.providers.Provider) {
